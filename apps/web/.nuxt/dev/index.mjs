...
import { createCall, createFetch } from 'file:///Users/zerotower/Documents/blog/vue/node_modules/.pnpm/unenv@1.9.0/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/zerotower/Documents/blog/vue/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/zerotower/Documents/blog/vue/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/zerotower/Documents/blog/vue/node_modules/.pnpm/scule@1.3.0/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/zerotower/Documents/blog/vue/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/zerotower/Documents/blog/vue/node_modules/.pnpm/ohash@1.1.3/node_modules/ohash/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/zerotower/Documents/blog/vue/apps/web/src/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/zerotower/Documents/blog/vue/apps/web","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/zerotower/Documents/blog/vue/apps/web/src/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/zerotower/Documents/blog/vue/apps/web/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/zerotower/Documents/blog/vue/apps/web/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/zerotower/Documents/blog/vue/apps/web/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _YSsOuOrPkm = (function(nitro) {
...
const getClientManifest = () => import('file:///Users/zerotower/Documents/blog/vue/apps/web/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/zerotower/Documents/blog/vue/apps/web/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
